    ...
    return(
      <div>
        ...
        <div className='flex flex-col gap-y-4 py-2'>
          <div className='rounded-xl bg-primary-Lightest px-4 py-5 flex justify-between items-center text-Neutral-black'>
            ...
            <button className="btn bg-primary-Dark px-2 py-2 rounded-lg w-w-1/10 text-white">Send email</button>
          </div>
          ...
          <div className='rounded-xl bg-primary-Lightest px-4 py-5 flex justify-between items-center text-Neutral-black'>
            ...
            <button className="btn bg-primary-Dark px-2 py-2 rounded-lg w-w-1/10 text-white">Set up</button>
          </div>
          
          <div className='rounded-xl px-4 py-5 flex justify-between items-center text-Neutral-black'>
            ...
            <button className="btn bg-Red-default px-2 py-2 rounded-lg w-w-1/10 text-white">Delete Account</button>
          </div>
        </div>
